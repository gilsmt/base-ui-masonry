...
| overscan       | `number`                                                                                 | `2`        | How far beyond the viewport, as a multiple of its height, items are rendered and unmeasured items are batched. The margin is larger ahead of the scroll direction than behind it. Use `Infinity` to disable windowing and render every item. |
