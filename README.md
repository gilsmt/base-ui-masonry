...
| ------------------------------------------------------------------------ | -------- | ------- | ------- |
| `masonry.tsx` alone (`@base-ui/*` external) — standalone copy/paste cost | 9.68 kB  | 4.10 kB | 3.70 kB |
| `masonry.tsx` + tree-shaken `@base-ui` deps                              | 16.27 kB | 6.59 kB | 5.92 kB |
...
| container      | `HTMLElement \| null`                                                                    | `window`   | Scroll container driving windowing. Pass the element that actually scrolls when the masonry sits inside an overflow container.                                                                                                     |
